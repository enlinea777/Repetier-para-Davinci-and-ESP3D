...
#define UI_TEXT_IDLE_ES             "Pos. Inicial"
...
#define UI_TEXT_PRINT_FILE_ES       "Imp. archivo"
...
#define UI_TEXT_DELETE_FILE_ES      "Borrando Archivo"
...
#define UI_TEXT_FAN_25_ES            "vent. 25%%%"
#define UI_TEXT_FAN_50_ES            "vent. 50%%%"
#define UI_TEXT_FAN_75_ES            "vent. 75%%%"
#define UI_TEXT_FAN_FULL_ES          "vent. 100%%%"
...
#define UI_TEXT_EEPROM_STOREDB_ES     "Guarda>EEPROM"
#define UI_TEXT_EEPROM_LOADEDA_ES     "Config."
#define UI_TEXT_EEPROM_LOADEDB_ES     "cargar<EEPROM"
...
#define UI_TEXT_TOP_COVER_OPEN_ES   "Tapa superior open!"
#define UI_TEXT_TOP_SENSOR_ONOFF_ES   "Sensor Tapa: %st"
#define UI_TEXT_VERSION_MENU_ES   "System Version"
#define UI_TEXT_COOLDOWN_MENU_ES   "Cooldown      %B3"
#define UI_TEXT_WAIT_OK_ES   "Ok para seguir"
...
#define UI_TEXT_MAINTENANCE_ES   "Herramientas"
#define UI_TEXT_SETTINGS_ES   "Opciones"
#define UI_TEXT_LOAD_UNLOAD_ES   "Load/Unload"
#define UI_TEXT_BED_ES   "CAMA"
#define UI_TEXT_BED_OFF_ES   "Apagar Cama %B7"
#define UI_TEXT_LIGHT_OFF_AFTER_ES   "Luz AutoOff "
...
#define UI_TEXT_MOVING_ES   "Moviendo..."
#define UI_TEXT_PREPARING_ES   "Preparando..."
#define UI_TEXT_KEEP_LIGHT_ON_ES   "Print w/LED:%lk"
#define UI_TEXT_LOADING_FILAMENT_ES   "Cargando \005"
#define UI_TEXT_UNLOADING_FILAMENT_ES   "Descarga \005"
#define UI_TEXT_LOADUNLOAD_FILAMENT_ES   "Carga / Descarga \005"
#define UI_TEXT_AUTOLEVEL_ES   "Auto Nivelar Cama"
#define UI_TEXT_Z_PROBE_FAILED_ES   "Prueba-Z fallida"
#define UI_TEXT_SAVE_ES   "Salvar a EEPROM?"
#define UI_TEXT_ZMIN_ES   "zMin : %zm"
#define UI_TEXT_ZPROBING_ES   "Probando..."
#define UI_TEXT_ZPOSITION_ES   "llendo a..."
...
#define UI_TEXT_EASY_MODE_ES   "Facil"
#define UI_TEXT_ADVANCED_MODE_ES   "Avanzado"
...
#define UI_TEXT_HEATING_ES   "Calentando..."
...
#define UI_TEXT_ON_JP                         "��" // " On"
#define UI_TEXT_OFF_JP                        "��" // "Off"
#define UI_TEXT_NA_JP                         "N/A" // Output for not available
#define UI_TEXT_YES_JP                        "Yes"
#define UI_TEXT_NO_JP                         " No"
#define UI_TEXT_PRINT_POS_JP                  "����ļϽ.."// "Printing.."
#define UI_TEXT_PRINTING_JP                   "����� ���" // "Printing"
#define UI_TEXT_IDLE_JP                       "�����" // "Idle"
#define UI_TEXT_NOSDCARD_JP                   "SD���� ż" // "No SD card"
#define UI_TEXT_ERROR_JP                      "**** ERROR ****"
#define UI_TEXT_BACK_JP                       "���� " cUP // "Back " cUP
#define UI_TEXT_QUICK_SETTINGS_JP             "���� ��ò" // "Quick settings"
#define UI_TEXT_ERRORMSG_JP                   "%oe"
#define UI_TEXT_CONFIGURATION_JP              "��̨�ޭڰ���" // "Configuration"
#define UI_TEXT_POSITION_JP                   "�߼޼��" // "Position"
#define UI_TEXT_EXTRUDER_JP                   "����ٰ�ް" // "Extruder"
#define UI_TEXT_SD_CARD_JP                    "SD����" // "SD card"
#define UI_TEXT_DEBUGGING_JP                  "���ޯ��ݸ�" // "Debugging"
#define UI_TEXT_HOME_DELTA_JP                 "Home ����" // "Home delta"
#define UI_TEXT_HOME_ALL_JP                   "Home ���"// "Home all"
#define UI_TEXT_HOME_X_JP                     "Home X"
#define UI_TEXT_HOME_Y_JP                     "Home Y"
#define UI_TEXT_HOME_Z_JP                     "Home Z"
#define UI_TEXT_PREHEAT_PLA_JP                "���˰�  PLA   %B1" // "Preheat PLA   %B1"
#define UI_TEXT_PREHEAT_ABS_JP                "���˰�  ABS   %B2" // "Preheat ABS   %B2"
#define UI_TEXT_LIGHTS_ONOFF_JP               "ײ�:        %lo" // "Lights:     %lo"
#define UI_TEXT_COOLDOWN_JP                   "����޳�" // "Cooldown"
#define UI_TEXT_SET_TO_ORIGIN_JP              "��� ��޽" // "Set to origin"
#define UI_TEXT_DISABLE_STEPPER_JP            "����߰ Ѻ�" // "Disable stepper"
#define UI_TEXT_X_POSITION_JP                 "X �߼޼��" // "X position"
#define UI_TEXT_X_POS_FAST_JP                 "X �߼�. ̧��" // "X pos. fast"
#define UI_TEXT_Y_POSITION_JP                 "Y �߼޼��" // "Y position"
#define UI_TEXT_Y_POS_FAST_JP                 "Y �߼�. ̧��" // "Y pos. fast"
#define UI_TEXT_Z_POSITION_JP                 "Z �߼޼��" // "Z position"
#define UI_TEXT_Z_POS_FAST_JP                 "Z �߼�. ̧��" // "Z pos. fast"
#define UI_TEXT_E_POSITION_JP                 "����ٰ�ް �߼�." // "Extr. position"
#define UI_TEXT_BED_TEMP_JP                   "�ޯ��:%eb/%Eb" cDEG "C" // "Bed :%eb/%Eb" cDEG "C"
#if NUM_EXTRUDER == 1
#define UI_TEXT_EXTR0_TEMP_JP                 "���� :%e0/%E0" cDEG "C" // "Ext :%e0/%E0" cDEG "C"
#else
#define UI_TEXT_EXTR0_TEMP_JP                 "����1:%e0/%E0" cDEG "C" // "Ext1 :%e0/%E0" cDEG "C"
#endif
#define UI_TEXT_EXTR1_TEMP_JP                 "����2:%e1/%E1" cDEG "C" // "Ext2 :%e1/%E1" cDEG "C"
#define UI_TEXT_EXTR2_TEMP_JP                 "����3:%e2/%E2" cDEG "C" // "Ext3 :%e2/%E2" cDEG "C"
#if NUM_EXTRUDER == 1
#define UI_TEXT_EXTR0_OFF_JP                  "���� �� ����. %B4" // "SwitchOff Ext %B4"
#else
#define UI_TEXT_EXTR0_OFF_JP                  "���� �� ����.1%B4" // "SwitchOff Ext1%B4"
#endif
#define UI_TEXT_EXTR1_OFF_JP                  "���� �� ����.2%B5" // "SwitchOff Ext2%B5"
#define UI_TEXT_EXTR2_OFF_JP                  "���� �� ����.3%B6" // "SwitchOff Ext3%B6"
#define UI_TEXT_EXTR0_SELECT_JP               "������ ����.1 %X0" // "Select Extr.1 %X0"
#define UI_TEXT_EXTR1_SELECT_JP               "������ ����.2 %X1" // "Select Extr.2 %X1"
#define UI_TEXT_EXTR2_SELECT_JP               "������ ����.3 %X2" // "Select Extr.3 %X2"
#define UI_TEXT_EXTR_ORIGIN_JP                "��� ��޽" // "Set Origin"
#define UI_TEXT_PRINT_X_JP                    "����� X:  %ax" // "Print X:  %ax"
#define UI_TEXT_PRINT_Y_JP                    "����� Y:  %ay" // "Print Y:  %ay"
#define UI_TEXT_PRINT_Z_JP                    "����� Z:  %az" // "Print Z:  %az"
#define UI_TEXT_PRINT_Z_DELTA_JP              "�����:%az" // "Print:%az"
#define UI_TEXT_MOVE_X_JP                     "��޳ X:   %aX" // "Move X:   %aX"
#define UI_TEXT_MOVE_Y_JP                     "��޳ Y:   %aY" // "Move Y:   %aY"
#define UI_TEXT_MOVE_Z_JP                     "��޳ Z:   %aZ" // "Move Z:   %aZ"
#define UI_TEXT_MOVE_Z_DELTA_JP               "��޳:     %aZ" // "Move:     %aZ"
#define UI_TEXT_JERK_JP                       "�ެ��:    %aj" // "Jerk:     %aj"
#define UI_TEXT_ZJERK_JP                      "Z-�ެ��:  %aJ" // "Z-Jerk:   %aJ"
#define UI_TEXT_ACCELERATION_JP               "����ڰ���" // "Acceleration"
#define UI_TEXT_STORE_TO_EEPROM_JP            "�ı \176 EEPROM" // "Store \176 EEPROM"
#define UI_TEXT_LOAD_EEPROM_JP                "۰�� \177 EEPROM" // "Load \177 EEPROM"
...
#define UI_TEXT_OPS_OFF_JP                    "%O0 OPS ��" // "%O0 OPS Off"
#define UI_TEXT_OPS_CLASSIC_JP                "%O1 OPS �׼��" // "%O1 OPS Classic"
#define UI_TEXT_OPS_FAST_JP                   "%O2 OPS ̧��" // "%O2 OPS Fast"
#define UI_TEXT_OPS_RETRACT_JP                "��׸�:      %Or" // "Retract:    %Or"
#define UI_TEXT_OPS_BACKSLASH_JP              "�ޯ��ׯ��:  %Ob" // "Backsl.:    %Ob"
#define UI_TEXT_OPS_MINDIST_JP                "Min.dist:   %Od"
#define UI_TEXT_OPS_MOVE_AFTER_JP             "��޳ ���: %Oa" // "Move after: %Oa"
#define UI_TEXT_ANTI_OOZE_JP                  "Anti Ooze"
#define UI_TEXT_PRINT_FILE_JP                 "̧�� �����" // "Print file"
#define UI_TEXT_PAUSE_PRINT_JP                "���� ò�" // "Pause Print"
#define UI_TEXT_CONTINUE_PRINT_JP             "����� ��޹�" // "Continue Print"
#define UI_TEXT_UNMOUNT_CARD_JP               "���� ��ϳ��" // "Unmount Card"
#define UI_TEXT_MOUNT_CARD_JP                 "���� ϳ��" // "Mount Card"
#define UI_TEXT_DELETE_FILE_JP                "̧�٦ ���ޮ" // "Delete file"
#define UI_TEXT_FEEDRATE_JP                   "̨���ڰ�" // "Feedrate"
...
#define UI_TEXT_ACTION_XPOSITION4B_JP         "Min���޽į��:%sx" // "Min endstop:%sx"
#define UI_TEXT_ACTION_XPOSITION4C_JP         "Max���޽į��:%sX" // "Max endstop:%sX"
#define UI_TEXT_ACTION_XPOSITION4D_JP         ""
#define UI_TEXT_ACTION_YPOSITION4A_JP         "Y:%x1 mm"
#define UI_TEXT_ACTION_YPOSITION4B_JP         "Min���޽į��:%sy" // "Min endstop:%sy"
#define UI_TEXT_ACTION_YPOSITION4C_JP         "Max���޽į��:%sY" // "Max endstop:%sY"
#define UI_TEXT_ACTION_YPOSITION4D_JP         ""
#define UI_TEXT_ACTION_ZPOSITION4A_JP         "Z:%x2 mm"
#define UI_TEXT_ACTION_ZPOSITION4B_JP         "Min���޽į��:%sz" // "Min endstop:%sz"
#define UI_TEXT_ACTION_ZPOSITION4C_JP         "Max���޽į��:%sZ" // "Max endstop:%sZ"
#define UI_TEXT_ACTION_ZPOSITION4D_JP         ""
#define UI_TEXT_ACTION_XPOSITION_FAST4A_JP    "X:%x0 mm"
#define UI_TEXT_ACTION_XPOSITION_FAST4B_JP    "Min���޽į��:%sx" // "Min endstop:%sx"
#define UI_TEXT_ACTION_XPOSITION_FAST4C_JP    "Max���޽į��:%sX" // "Max endstop:%sX"
#define UI_TEXT_ACTION_XPOSITION_FAST4D_JP    ""
#define UI_TEXT_ACTION_YPOSITION_FAST4A_JP    "Y:%x1 mm"
#define UI_TEXT_ACTION_YPOSITION_FAST4B_JP    "Min���޽į��:%sy" // "Min endstop:%sy"
#define UI_TEXT_ACTION_YPOSITION_FAST4C_JP    "Max���޽į��:%sY" // "Max endstop:%sY"
#define UI_TEXT_ACTION_YPOSITION_FAST4D_JP    ""
#define UI_TEXT_ACTION_ZPOSITION_FAST4A_JP    "Z:%x2 mm"
#define UI_TEXT_ACTION_ZPOSITION_FAST4B_JP    "Min���޽į��:%sz" // "Min endstop:%sz"
#define UI_TEXT_ACTION_ZPOSITION_FAST4C_JP    "Max���޽į��:%sZ" // "Max endstop:%sZ"
#define UI_TEXT_ACTION_ZPOSITION_FAST4D_JP    ""
#define UI_TEXT_ACTION_EPOSITION_FAST2A_JP    "E:%x3 mm"
#define UI_TEXT_ACTION_EPOSITION_FAST2B_JP    "1 �د� = 1 mm" // "1 click = 1 mm"
...
#define UI_TEXT_FANSPEED_JP                   "̧ݽ�߰��" // "Fan speed"
#define UI_TEXT_ACTION_FANSPEED_JP            "̧ݽ�߰��:%Fs%%%" // "Fan speed:%Fs%%%"
#define UI_TEXT_FAN_OFF_JP                    "̧� ò�" // "Turn Fan Off"
#define UI_TEXT_FAN_25_JP                     "��߰�� 25%%%" // "Set Fan 25%%%"
#define UI_TEXT_FAN_50_JP                     "��߰�� 50%%%" // "Set Fan 50%%%"
#define UI_TEXT_FAN_75_JP                     "��߰�� 75%%%" // "Set Fan 75%%%"
#define UI_TEXT_FAN_FULL_JP                   "����߰��" // "Set Fan Full"
#define UI_TEXT_STEPPER_INACTIVE_JP           "��ï�߰ Ѻ�" // "Steppers Inact"
#define UI_TEXT_STEPPER_INACTIVE2A_JP         "Ѻ� ���:%is" // "Dis. After:%is"
#define UI_TEXT_STEPPER_INACTIVE2B_JP         "[min] 0=��" // "[min] 0=Off"
#define UI_TEXT_POWER_INACTIVE_JP             "Max. Ѻ�" // "Max. Inact."
#define UI_TEXT_POWER_INACTIVE2A_JP           "Ѻ� ���:%ip" // "Dis. After:%ip"
#define UI_TEXT_POWER_INACTIVE2B_JP           "[min] 0=��" // "[min] 0=Off"
#define UI_TEXT_GENERAL_JP                    "�ު���" // "General"
#define UI_TEXT_BAUDRATE_JP                   "Baudrate:%oc"
#define UI_TEXT_EXTR_STEPS_JP                 "�ï��/MM: %Se" // "Steps/MM: %Se"
...
#define UI_TEXT_STRING_ACTION_JP              "�����:%la" // "Action:%la"
#define UI_TEXT_HEATING_EXTRUDER_JP           "����ٰ�ް ˰����%Ne" // "Heating Extruder%Ne"
#define UI_TEXT_HEATING_BED_JP                "�ޯ�� ˰����" // "Heating Bed"
#define UI_TEXT_KILLED_JP                     "�į�� ��خ�" // "Stopped"
#define UI_TEXT_STEPPER_DISABLED_JP           "�ï�߰ Ѻ�" // "Stepper Disabled"
#define UI_TEXT_EEPROM_STOREDA_JP             "��̨��ڰ���" // "Configuration"
#define UI_TEXT_EEPROM_STOREDB_JP             "�ı ��� \176 EEPROM" // "stored \176 EEPROM"
#define UI_TEXT_EEPROM_LOADEDA_JP             "��̨��ڰ���" // "Configuration"
#define UI_TEXT_EEPROM_LOADEDB_JP             "۰�� ��� \177 EEPROM" // "loaded \177 EEPROM"
#define UI_TEXT_UPLOADING_JP                  "����۰�����..." // "Uploading..."
#define UI_TEXT_PAGE_BUFFER_JP                "�ޯ̧�:%oB" // "Buffer:%oB"
...
#define UI_TEXT_SPEED_MULTIPLY_JP             "Mul.��߰��:%om%%%" // "Speed Mul.:%om%%%"
#define UI_TEXT_FLOW_MULTIPLY_JP              "Mul.�۰:   %of%%%" // "Flow Mul.: %of%%%"
#define UI_TEXT_SHOW_MEASUREMENT_JP           "���� ˮ���" // "Show meas."
#define UI_TEXT_RESET_MEASUREMENT_JP          "���� ؾ��" // "Reset meas."
#define UI_TEXT_SET_MEASURED_ORIGIN_JP        "��� Z=0" // "Set Z=0"
#define UI_TEXT_ZCALIB_JP                     "Z �����" // "Z Calib."
#define UI_TEXT_SET_P1_JP                     "��� P1" // "Set P1"
#define UI_TEXT_SET_P2_JP                     "��� P2" // "Set P2"
#define UI_TEXT_SET_P3_JP                     "��� P3" // "Set P3"
#define UI_TEXT_CALCULATE_LEVELING_JP         "���� ����" // "Calculate Leveling"
#define UI_TEXT_LEVEL_JP                      "���� ����" // "Level delta"
#define UI_TEXT_EXTR_WAIT_RETRACT_TEMP_JP     "���� ��: %XT" cDEG "C" // "Wait T.: %XT" cDEG "C"
#define UI_TEXT_EXTR_WAIT_RETRACT_UNITS_JP    "�Ư� ��:  %XU mm" // "Wait U.:  %XU mm"
#define UI_TEXT_SD_REMOVED_JP                 "SD���ަ ǲ�" // "SD Card removed"
#define UI_TEXT_SD_INSERTED_JP                "SD���ަ ���" // "SD Card inserted"
#define UI_TEXT_PRINTER_READY_JP              "�ޭ��� ��خ�" // "Printer ready."
#define UI_TEXT_PRINTTIME_DAYS_JP             "�� " // " days  "
#define UI_TEXT_PRINTTIME_HOURS_JP            "h" // ":"
#define UI_TEXT_PRINTTIME_MINUTES_JP          "m" // ""
#define UI_TEXT_PRINT_TIME_JP                 "����� ���" // "Printing time"
#define UI_TEXT_PRINT_FILAMENT_JP             "̨���� �����" // "Filament printed"
#define UI_TEXT_PRINTED_JP                    "�����" // "printed"
#define UI_TEXT_POWER_JP                      "ATX ��ܰ ��/��" // "ATX power on/off"
#define UI_TEXT_STRING_HM_DEADTIME_JP         " �ޯ�� ���" // " Dead Time"
#define UI_TEXT_STRING_HM_SLOWBANG_JP         "  SlowBang"
#define UI_TEXT_STOP_PRINT_JP                 "����� �į��" // "Stop Print"
...
#define UI_TEXT_COATING_CUSTOM_JP             "����: %BCmm" // "Custom: %BCmm"
...
#if NUM_EXTRUDER == 1
#define UI_TEXT_FIL_SENSOR_ONOFF_JP           "̨���� �ݻ�:%sf" // "Fil.Sensor: %sf"
#define UI_TEXT_CLEANING_DRIPBOX_JP           "Dripbox �ذ�ݸ�" // "Cleaning Dripbox"
#define UI_TEXT_CLEAN_DRIPBOX_JP              "Dripbox� ���޽" // "Clean Dripbox"
#define UI_TEXT_CLEAN_DRIPBOX_3_JP            "Dripbox"
#define UI_TEXT_EXTR_XOFF_JP                  "Xoffst:%Xxmm"
#define UI_TEXT_EXTR_YOFF_JP                  "Yoffst:%Xymm"
#else
#define UI_TEXT_FIL_SENSOR_ONOFF_JP           "̨���� �ݻ�:%sf" // "Fil.Sensors:%sf"
#define UI_TEXT_CLEAN_DRIPBOX_JP              "Dripbox �ذ�ݸ�" // "Clean Dripboxes"
#define UI_TEXT_CLEANING_DRIPBOX_JP           "Dripbox� ���޽" // "Cleaning Dripboxes"
...
#define UI_TEXT_BED_DOWN_JP                   "�ޯ�ަ ����" // "Bed Down"
#define UI_TEXT_WIFI_ONOFF_JP                 "Wifi:       %wo"
#define UI_TEXT_REDO_ACTION_JP                "ӳ ���� �ޯ��?" // "Do it again ?"
...
#define UI_TEXT_ALERT_NO_FILAMENTA_JP         "����ٰ�ް%Ne �" // "Extruder%Ne has no"
#define UI_TEXT_ALERT_NO_FILAMENTB_JP         "̨���Ķ� ��Ͼ�" // "filament !"
#define UI_TEXT_ALERT_NO_FILAMENTC_JP         "OK���� ̨���Ħ" // "Push Ok to go to"
#define UI_TEXT_ALERT_NO_FILAMENTD_JP         "���ݼ� ��޻�" // "change filament"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_1A_JP   "��ׯ�̫��� ��Ʊ�" // "Find the 3 knobs"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_1B_JP   "3�� �����ȼަ   " // "on the bottom of"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_1C_JP   "���ݼ, �ڿ�ڦ   " // "platform and"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_1D_JP   "4�� ��¹ø�޻�. " //"tighten 4 turns."
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_2A_JP   "����ٰ�ް�޲۲��" // "I am going to"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_2B_JP   "��� ��޳�Ͻ���, " // "move extruder to"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_2C_JP   "�ڿ��� ���� ����" // "some positions"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_2D_JP   "������ø�޻�.   " // "for adjustment."
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_3A_JP   "�ڿ��� ����     " // "In each position"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_3B_JP   "2�� ��ަ        " // "we will need to"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_3C_JP   "�޳��� �ܼ�     " // "adjust 2 knobs"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_3D_JP   "������Ͻ        " // "at same time."
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_4A_JP   "1ϲ� �߰�߰�    " // "Nozzle is on the"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_4B_JP   "ֳ��ø�޻�.ɽ���" // "right height if"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_4C_JP   "��ڰ��� ��Ϧ    " // "can just slide"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_4D_JP   "�ײ�޻��ֳƼ�   " // "a sheet of paper"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_5A_JP   "ɽ�ٶ� ��޼�����" // "between nozzle"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_5B_JP   "��ֳƼϽ.       " // "and plate. Grab"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_5C_JP   "�߰�߰�ֳ��� �޷" // "a sheet of paper"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_5D_JP   "ϼ�� ���ø�޻�. " // "to proceed."
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_6A_JP   "�ϴ� �����ȼ��� " // "Adjust the front"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_6B_JP   "���� �������,   " // "knob(s) so paper"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_6C_JP   "ɽ��� ��ڰ���   " // "just slides amid"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_6D_JP   "��Ϧ ���ݼø�޻�" // "nozzle and plate"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_7A_JP   "��� �����ȼ���  " // "Adjust the back"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_7B_JP   "���� �������,   " // "knob(s) so paper"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_7C_JP   "ɽ��� ��ڰ���   " // "just slides amid"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_7D_JP   "��Ϧ ���ݼø�޻�" // "nozzle and plate"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_8A_JP   "з޵�� �����ȼ� " // "Adjust the back"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_8B_JP   "�� ���� �������," // "and right knobs"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_8C_JP   "ɽ��� ��ڰ���   " // "until paper just"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_8D_JP   "��Ϧ ���ݼø�޻�" // "slides."
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_9A_JP   "���ص�� �����ȼ�" // "Adjust the back"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_9B_JP   "�� ���� �������," // "and left knobs"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_9C_JP   "ɽ��� ��ڰ���   " // "until paper just"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_9D_JP   "��Ϧ ���ݼø�޻�" // "slides."
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_10A_JP  "�����޽. �߰�߰�" // "Check that paper"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_10B_JP  "�ײ�޻��ֳƼ�   " // "just slides"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_10C_JP  "ɽ��� ��ڰ���   " // "between nozzle"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_10D_JP  "��Ϧ ���ݼø�޻�" // "and plate."
...
#define UI_TEXT_TOP_COVER_OPEN_JP             "į�߶�ް�� ��ò�!" // "Top cover open!"
#define UI_TEXT_TOP_SENSOR_ONOFF_JP           "į�߾ݻ�  : %st" // "Top Sensor: %st"
#define UI_TEXT_VERSION_MENU_JP               "���� �ް�ޮ�" // "System Version"
#define UI_TEXT_COOLDOWN_MENU_JP              "����޳�       %B3" // "Cooldown      %B3"
#define UI_TEXT_WAIT_OK_JP                    "OK � ��ø�޻�" // "Ok to continue"
#define UI_TEXT_FAILED_JP                     "���߲" // "Failed"
#define UI_TEXT_PLEASE_WAIT_JP                "�����޻�" // "Please wait"
#define UI_TEXT_MANUAL_LEVEL_JP               "���޳ �����" // "Manual leveling"
#define UI_TEXT_WARNING_JP                    "ܰ�ݸ�!" // "Warning!"
#define UI_TEXT_EXTRUDER_COLD_JP              "E%Ne�� ˴òϽ!" // "E%Ne is too cold!"
#define UI_TEXT_HEAT_EXTRUDER_JP              "����ٰ�ް ����?" // "Heat extruder ?"
#define UI_TEXT_WRITE_DEBUG_JP                "Write Debug"
#define UI_TEXT_POWER_SAVE_MENU_JP            "��ܰ����" // "Powersave"
#define UI_TEXT_MAINTENANCE_JP                "����ݽ" // "Maintenance"
#define UI_TEXT_SETTINGS_JP                   "��ò" // "Settings"
#define UI_TEXT_LOAD_UNLOAD_JP                "۰��/��۰��" // "Load/Unload"
#define UI_TEXT_BED_JP                        "�ޯ��" // "Bed"
#define UI_TEXT_BED_OFF_JP                    "�ޯ�� �� %B7"// "SwitchOff Bed %B7"
#define UI_TEXT_LIGHT_OFF_AFTER_JP            "ײ� ��ĵ�" // "Light AutoOff"
#define UI_TEXT_LIGHT_OFF_AFTER2A_JP          "����ϰ�޶�:%il" // "Dis. After:%il"
#define UI_TEXT_LIGHT_OFF_AFTER2B_JP          "[min] 0=��" // "[min] 0=Off"
#define UI_TEXT_WARNING_POS_X_UNKNOWN_JP      "�ޯ�� �ɳ X !" // "Real X unknown !"
#define UI_TEXT_WARNING_POS_Y_UNKNOWN_JP      "�ޯ�� �ɳ Y !" // "Real Y unknown !"
#define UI_TEXT_WARNING_POS_Z_UNKNOWN_JP      "�ޯ�� �ɳ Z !" // "Real Z unknown !"
#define UI_TEXT_MOVING_JP                     "��޳ ���..." // "Moving..."
#define UI_TEXT_PREPARING_JP                  "�ޭ��� ���..." // "Preparing..."
#define UI_TEXT_KEEP_LIGHT_ON_JP              "����� w/LED:%lk" // "Print w/LED:%lk"
#define UI_TEXT_LOADING_FILAMENT_JP           "۰����� \005" // "Loading \005"
#define UI_TEXT_UNLOADING_FILAMENT_JP         "��۰����� \005" // "Unloading \005"
#define UI_TEXT_LOADUNLOAD_FILAMENT_JP        "۰�� / ��۰�� \005" // "Load / Unload \005"
#define UI_TEXT_AUTOLEVEL_JP                  "�ޯ�� ��������" // "Auto level bed"
#define UI_TEXT_Z_PROBE_FAILED_JP             "Z-��۰�� ���߲" // "Z-probe failed"
#define UI_TEXT_SAVE_JP                       "EEPROM� ο��?" // "Save to EEPROM ?"
#define UI_TEXT_ZMIN_JP                       "zMin : %zm"
#define UI_TEXT_ZPROBING_JP                   "��۰�����..." // "Probing..."
#define UI_TEXT_ZPOSITION_JP                  "Go position..."
#define UI_TEXT_DO_YOU_JP                     "�ޯ���Ͻ�:" // "Do you want to:"
#define UI_TEXT_CLEAN1_JP                     "ʼ��� ɽ���" // "Clean nozzle and"
#define UI_TEXT_CLEAN2_JP                     "��ڰĦ ���޼Ͻ�?" // "plates first ?"
#define UI_TEXT_DISPLAY_MODE_JP               "Ӱ��:%Md" // "Mode:%Md"
#define UI_TEXT_EASY_MODE_JP                  "      ����" // "      Easy"
#define UI_TEXT_ADVANCED_MODE_JP              " �����ݽ��" // "  Advanced"
#define UI_TEXT_POWER_SAVE_JP                 "��ܰ���� :%Ps" // "Powersave:%Ps"
#define UI_TEXT_BADGE_LIGHT_ONOFF_JP          "�ޯ��� ײ�:%lb" // "Badge light:%lb"
#define UI_TEXT_SOUND_ONOF_JP                 "�����:      %so" // "Sound:      %so"
#define UI_TEXT_YES_SELECTED_JP               "  [Yes]    No"
#define UI_TEXT_NO_SELECTED_JP                "   Yes    [No] "
#define UI_TEXT_PLEASE_CONFIRM_JP             "���ݼ� ��޻�" // "Please confirm"
#define UI_TEXT_CANCEL_ACTION_JP              "��ݾ�:" // "Cancel:"
#define UI_TEXT_CONTINUE_ACTION_JP            "��޹�" // "Continue"
#define UI_TEXT_CANCELED_JP                   "��ݾټϼ�" // "Action canceled!"
#define UI_TEXT_CONFIRMED_JP                  "���ݼϼ�" // "Action confirmed!"
#define UI_TEXT_CLEAN_NOZZLE_JP               "ɽ�� �ذ�"// "Clean Nozzle"
#define UI_TEXT_CLEANING_NOZZLE_JP            "ɽ�� �ذ�ݸ�" // "Cleaning Nozzle"
#define UI_TEXT_CLEAN_DRIPBOX_1_JP            "Dripbox� ���޼�" // "Please Take"
#define UI_TEXT_CLEAN_DRIPBOX_2_JP            "���ަ �ø�޻�" // "And Clean"
#define UI_TEXT_PUSH_FILAMENT_JP              "̨����� Ƿ/��" // "Push Filament"
#define UI_TEXT_WAIT_FILAMENT_JP              "OK �� ����" // "Push Ok to start"
#define UI_TEXT_LOAD_FAILSAFE2_JP             "after loading ?"
#define UI_TEXT_LOAD_FAILSAFE_JP              "Load Fail-Safe"
#define UI_TEXT_HEATING_JP                    "����òϽ..." // "Heating..."
#define UI_TEXT_WAIT_FOR_OK_JP                "OK �� ���" // "Press Ok to end"
#if NUM_EXTRUDER == 1
...
#endif
#define UI_TEXT_AUTOLEVEL_MATRIX_JP           "������� ��د��" // "Autolevel Matrix"
#if HAVE_HEATED_BED
///Davinci Specific, page 1-2-3, they are different if you have 1 or 2 extruders, and if you are in Easy Mode or Advanced Mode
#if NUM_EXTRUDER == 1
...
#define UI_TEXT_P1_L2_JP                      "Z:%x2"
#define UI_TEXT_P1_L3_JP                      "�ޯ̧�:%oB" // "Buffer:%oB"

#define UI_TEXT_P1_L1_EASY_JP                 "\005%ec/%Ec\002"
#define UI_TEXT_P1_L2_EASY_JP                 "Z:%x2"
#define UI_TEXT_P1_L3_EASY_JP                 "�ޯ̧�:%oB" // "Buffer:%oB"
#else
#define UI_TEXT_P1_L1_JP                      "\005%e0/%E0\005%e1/%E1"
#define UI_TEXT_P1_L2_JP                      "Z:%x2"
#define UI_TEXT_P1_L3_JP                      "�ޯ̧�:%oB" // "Buffer:%oB"
...
#define UI_TEXT_MENU_SCANNER_JP               "���Ű" // "Scanner"
#define UI_TEXT_PREPARE_SCANNER_JP            "���Ű �ޭ���" // "Prepare scan"
#define UI_TEXT_LASER1_ONOFF_JP               "Laser з�  :%PA" // "Right laser:%PA"
#define UI_TEXT_LASER2_ONOFF_JP               "Laser ���� :%PB" // "Left laser :%PB"
#define UI_TEXT_LED1_ONOFF_JP                 "LED з�    :%P1" // "Right LED  :%P1"
#define UI_TEXT_LED2_ONOFF_JP                 "LED ����   :%P2" // "Left LED   :%P2"
#define UI_TEXT_CHANGE_TABLE_SPEED_JP         "��߰��:%PS" // "Speed :%PS"
#define UI_TEXT_ROTATION_TABLE_JP             "۰ð� +/-" // "Rotate +/-"
#define UI_TEXT_RELEASE_TABLE_JP              "ð��� �ذ�" // "Release table"
#define UI_TEXT_Z_MIN_CALCULATION_JP          "Zmin ˮ��" // "Zmin evaluation"
